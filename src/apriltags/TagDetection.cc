...
Eigen::Matrix4d TagDetection::getRelativeTransform(double tag_size, double fx, double fy, double px, double py, cv::Mat& rvec, cv::Mat& tvec) const {
...
void TagDetection::getRelativeTranslationRotation(double tag_size, double fx, double fy, double px, double py,
  ...
  Eigen::Matrix4d T =
    getRelativeTransform(tag_size, fx, fy, px, py, rvec, tvec);
  ...
  // translation vector from April Tag to Camera
